...
navbar = dbc.NavbarSimple(
    brand='Video Game Sales Predictor',
    brand_href='/', 
    children=[
    ...
    brand_style={'fontSize':'calc(15px + 0.8vmin)'},
)
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Timothy Hsu', className='mr-2'),
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/timtree/vgsales-project/'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/timothy-hsu-72877a171/'),
                    html.A(html.Span('Games by Tim',style={'fontSize':'60%'}), href='https://www.gamesbytim.com/'),
                ], 
                className='lead'
            )
        )
